...
```{r,echo=FALSE}
knitr::include_url("https://www.tandfonline.com/doi/pdf/10.1080/02664763.2023.2233057")
```

<!--
The `cornet` manuscript is in press. Click [here](https://CRAN.R-project.org/package=cornet) for the R package.
-->
