...
box <- function(x,y,width=0.22,height=0.2,labels="",col="black",...){
...
box(x=0+h,y=0.5,labels="dichotomised\noutcome")
...
graphics::text(x=0.35,y=0.55,labels="logistic\nregression",col="red",cex=0.7,pos=3)
#graphics::text(x=0.32,y=0.4,labels=expression(beta),col=blue,cex=2)
graphics::text(x=0.35,y=0.45,labels="linear\nregression",col="blue",cex=0.7,pos=1)
