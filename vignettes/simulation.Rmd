...
This script requires that the working directory includes the folders "data", "results", and "manuscript". We obtained our results using R 3.6.1 (2019-07-05) with cornet 0.0.3 (2019-10-02) on a local machine (x86_64-w64-mingw32/x64, Windows 10 x64), and verified them on a virtual machine (x86_64-pc-linux-gnu, Ubuntu 16.04.6). Floating point errors might lead to slightly different results on other platforms.
...
grDevices::pdf("manuscript/figure_BOX.pdf",width=6,height=3)
